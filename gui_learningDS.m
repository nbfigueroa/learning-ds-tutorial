function varargout = gui_learningDS(varargin)
%GUI_LEARNINGDS MATLAB code file for gui_learningDS.fig
%      GUI_LEARNINGDS, by itself, creates a new GUI_LEARNINGDS or raises the existing
%      singleton*.
%
%      H = GUI_LEARNINGDS returns the handle to a new GUI_LEARNINGDS or the handle to
%      the existing singleton*.
%
%      GUI_LEARNINGDS('Property','Value',...) creates a new GUI_LEARNINGDS using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to gui_learningDS_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      GUI_LEARNINGDS('CALLBACK') and GUI_LEARNINGDS('CALLBACK',hObject,...) call the
%      local function named CALLBACK in GUI_LEARNINGDS.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help gui_learningDS

% Last Modified by GUIDE v2.5 27-Jun-2018 19:45:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_learningDS_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_learningDS_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_learningDS is made visible.
function gui_learningDS_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for gui_learningDS
...
% UIWAIT makes gui_learningDS wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_learningDS_OutputFcn(hObject, eventdata, handles)
